...
public class CompleteVideosEventHandler implements VideoEventHandler {
    private static final String TAG = CompleteVideosEventHandler.class.getSimpleName();
    public VideosRepository repository;

    public CompleteVideosEventHandler(VideosRepository repository) {
